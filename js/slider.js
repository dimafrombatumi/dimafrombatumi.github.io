...
class ItcSlider {
    static WRAPPER_SELECTOR = '.partners-wrap-slider';
    static ITEMS_SELECTOR = '.partner-blocks';
    static ITEM_SELECTOR = '.partner-block';
    ...
    static CLASS_ITEM_ACTIVE = 'partner-block_active';
